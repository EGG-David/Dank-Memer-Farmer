...
setTitle('Dank Memer Grinding Tool')

client.on("ready", async () =>{
    console.log(clc.green('Dank Memer Tool is Online and Connected to ' + (config.accID) + '!\n'));
    ...
    console.log(clc.redBright('autoDig => [' + (config.autoDig) + ']' ))
    ...
    console.log(clc.blueBright('Type $startdankgrind in any server to begin generating!'));
...
client.on("message", async message => 
{
    ...
    {
        if (message.content === "$startdankgrind")
        {
            message.delete('$startdankgrind')
    ...
    function autoDig()
    {
        ...
        setTimeout(autoDig, 65000)
        DigNumber +=1
        console.log(clc.red('Dag ' + DigNumber + ' Times!\n'))
    }
